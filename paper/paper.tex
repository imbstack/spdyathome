...
that do not support S+M, but it quite a bit of latency to beginning the actual
communication and is one of the reasons that Facebook endorsed SPDY over
S+M~\cite{fbook}.
...
and 40\% could load using one-fifth the connections.
